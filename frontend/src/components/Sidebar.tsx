      ...
      <div className="flex-1 overflow-y-auto">
        ...
        <div className="p-4 border-b border-slate-800/60">
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="section-label">ML Engine — Random Forest</span>
            <span className="ml-auto text-[9px] bg-purple-950/40 text-purple-400 border border-purple-900/40 px-2 py-0.5 rounded-full font-semibold">
              {t('rf_active')}
            </span>
          </div>
